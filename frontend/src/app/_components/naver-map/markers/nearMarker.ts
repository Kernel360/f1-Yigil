export const nearMarker = (name: string) => {
  return {
    content: `<div style=" border: 1px #374151 solid; border-radius: 5px; background-color: #fff; word-break:keep-all;">
      ...
      <div style="position:absolute; bottom:-6px; left: 45%; width: 12px; height:12px; background-color:#fff; border-bottom: 1px #374151 solid; border-right:1px #374151 solid; border-bottom-right-radius: 3px; transform: rotate(45deg);"></div>
      </div>`,
