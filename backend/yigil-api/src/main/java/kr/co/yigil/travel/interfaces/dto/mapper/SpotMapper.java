...
public interface SpotMapper {
    ...
    MyFavoriteSpotsResponse of(SpotInfo.MyFavoriteSpotsInfo myFavoriteSpotsInfo);

    MyFavoriteSpotsResponse.FavoriteSpotDto of (SpotInfo.FavoriteSpotInfo favoriteSpotInfo);
