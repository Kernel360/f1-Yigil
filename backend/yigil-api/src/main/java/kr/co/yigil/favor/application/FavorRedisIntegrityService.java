...
//
//    @Transactional
//    public FavorCount ensureFavorCounts(Long travelId) {
...
//        } else {
//            FavorCount favorCount = getFavorCount(travelId);
//            favorCountRepository.save(favorCount);
//            return favorCount;
//        }
//    }
//
//    private FavorCount getFavorCount(Long travelId) {
//        return new FavorCount(travelId, favorRepository.countByTravelId(travelId));
//    }
//}
