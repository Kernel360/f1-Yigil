...
import kr.co.yigil.follow.interfaces.dto.FollowResponse;
import kr.co.yigil.follow.interfaces.dto.UnfollowResponse;
...
public class FollowApiController {
    ...
    public ResponseEntity<FollowersResponse> getMemberFollowerList(
        ...
        PageRequest pageRequest = PageRequest.of(pageable.getPageNumber() - 1,
            pageable.getPageSize(),
            Sort.by(direction, sortBy.getValue()));
        FollowInfo.FollowersResponse followerList = followFacade.getFollowerList(memberId,
            pageRequest);
    ...
    public ResponseEntity<FollowingsResponse> getMemberFollowingList(
        ...
        PageRequest pageRequest = PageRequest.of(pageable.getPageNumber() - 1,
            pageable.getPageSize(),
            Sort.by(direction, sortBy.getValue()));
        FollowInfo.FollowingsResponse followingList = followFacade.getFollowingList(memberId,
            pageRequest);
