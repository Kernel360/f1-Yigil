...
class CommentApiControllerTest {
    ...
    void whenGetParentCommentList_thenReturns200AndCommentResponse() throws Exception {
        ...
        CommentDto.CommentsUnitInfo mockUnitInfo1 = new CommentDto.CommentsUnitInfo(false,
                1L, "content", 1L, "nickname", "http://yigil.co.kr/images/profile.jpg", 3,
                "2024-03-01");

        CommentDto.CommentsUnitInfo mockUnitInfo2 = new CommentDto.CommentsUnitInfo(false,
        ...
        mockMvc.perform(get("/api/v1/comments/travels/{travelId}", 1L)
                ...
                .andDo(document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content[].deleted").type(JsonFieldType.BOOLEAN).description("삭제 여부"),
