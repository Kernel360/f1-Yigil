...
public class FileUploadEventTest {
    ...
    void shouldDetermineFileTypeAsImage() {
        ...
        FileUploadEvent event = new FileUploadEvent(new Object(), file,"image");
    ...
    void shouldThrowExceptionForExceedingFileSize() {
        ...
        assertThrows(FileException.class, () -> new FileUploadEvent(new Object(), largeFile, "image"));
    }
    ...
    void shouldProcessValidFile() {
        ...
        assertDoesNotThrow(() -> new FileUploadEvent(new Object(), file, "image"));
    }
    ...
    void shouldThrowExceptionForEmptyFileType() {
        ...
        assertThrows(FileException.class, () -> new FileUploadEvent(new Object(), file, "image"));
    }
}
